...
const checks = [
  ...
  },
  {
    ...
    ok:
      ...
      /CHANNEL_IMAGE_VARIANT_PIPELINE_VERSION = 6/.test(imagePreparation),
  },
  {
  ...
  {
    name: "tests historiques alignés sur les caches version 6",
    ok:
      /CHANNEL_IMAGE_VARIANT_PIPELINE_VERSION = 6/.test(historicalOriginalFirstTest) &&
