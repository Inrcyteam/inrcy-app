...
export default function ConfidentialiteContent() {
  return (
    <section>
      ...
      <ul className={styles.ul}>
        <li>
          <strong>Supabase</strong> : authentification, base de données, fonctions server-side.
        </li>
        <li>
          <strong>Stripe</strong> : paiements, abonnements, facturation.
        </li>
        <li>
          <strong>Vercel</strong> : hébergement et exécution de l’application web.
        </li>
        <li>
          <strong>OVHcloud</strong> : hébergement d’infrastructures et/ou services associés.
        </li>
      ...
      <ul className={styles.ul}>
        ...
        <li>
          Compte abonné : conservation pendant la durée de la relation contractuelle, puis archivage légal si nécessaire.
        </li>
      ...
      <p className={styles.p}>
        ...
        D’autres cookies (mesure d’audience / services tiers) peuvent être soumis à consentement selon le paramétrage.
      </p>
