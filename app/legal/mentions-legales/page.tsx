...
export default function MentionsLegalesPage() {
  return (
    <LegalPageShell title="Mentions légales" subtitle="Éditeur, hébergement, responsabilité, propriété intellectuelle.">
      <section>
        ...
        <ul className={styles.ul}>
          <li>Vente de site internet : en cas de vente, le client devient propriétaire du site livré, hors composants sous licence et technologies propriétaires iNrCy.</li>
          <li>Location de site internet : en cas de location, les structures, développements, éléments techniques et dispositifs restent la propriété exclusive de iNrCy. Aucun transfert de propriété n’intervient.</li>
        </ul>
        ...
        <p className={styles.p}>
          ...
          L’utilisateur reconnaît utiliser le site et le logiciel sous sa responsabilité exclusive.
          La responsabilité de iNrCy ne saurait être engagée sauf en cas de faute lourde ou intentionnelle.
        </p>

        <h2 className={styles.h2}>Conditions d’utilisation</h2>
        <p className={styles.p}>
          L’accès au site internet et au logiciel en ligne implique l’acceptation :
        </p>
        <ul className={styles.ul}>
