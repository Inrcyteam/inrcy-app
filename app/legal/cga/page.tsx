...
export default function CgaPage() {
  return (
    <LegalPageShell title="CGA — Conditions Générales d’Abonnement" subtitle="Version du 11/02/2026">
      <section>
        ...
        <p className={styles.p}>Le logiciel peut interagir avec des services tiers (Google, Microsoft, Meta, messagerie).</p>
