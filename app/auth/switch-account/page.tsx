...
export default function SwitchAccountPage() {
  ...
  const currentEmail = useMemo(() => searchParams.get("current_email") || null, [searchParams]);
  const expectedEmail = useMemo(() => searchParams.get("expected_email") || null, [searchParams]);
  const continuePath = useMemo(() => safeContinuePath(searchParams.get("continue")), [searchParams]);
