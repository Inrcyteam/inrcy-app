...
export async function GET() {
  ...
  const content = [
    ...
    "",
    "## Points d’entrée",
    "- Annuaire public : https://inrcy.com/annuaire/",
    `- Sitemap : ${origin}/sitemap.xml`,
    "",
    "## Fiches professionnelles",
    `Chaque fiche publique est disponible à l’adresse ${origin}/entreprises/{slug}. Une version texte dédiée aux moteurs de réponse est disponible à la même adresse suivie de /llms.txt.`,
    "",
    "## Règle de confiance",
