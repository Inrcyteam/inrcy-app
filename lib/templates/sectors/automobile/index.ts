...
import { concessionJobTemplates } from './concession';
...
export function buildAutomobileJobTemplates() {
  return [carrosserieJobTemplates, centre_autoJobTemplates, concessionJobTemplates, controle_techniqueJobTemplates, depannage_autoJobTemplates, garage_autoJobTemplates, garage_motoJobTemplates, lavage_autoJobTemplates, location_vehiculesJobTemplates, pare_briseJobTemplates].flatMap((definition) => createJobTemplates(definition));
}
