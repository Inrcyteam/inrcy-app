...
export function buildTrialReminderEmail(input: TrialReminderInput) {
  ...
  const subtitle =
    "Continuez sans interruption en activant votre abonnement. Le prélèvement ne commencera qu’à la fin de l’essai.";

  const body1 =
    daysBeforeEnd <= 1
      ? `Votre essai iNrCy se termine <strong>demain</strong> (${endDateFr}).`
      : `Votre essai iNrCy se termine le <strong>${endDateFr}</strong> (J-${daysBeforeEnd}).`;
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f4f7fb;">
      <tr>
        <td align="center" style="padding:24px 12px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border-radius:14px;box-shadow:0 10px 30px rgba(15,23,42,.08);overflow:hidden;">
            <tr>
                  ...
                  <tr>
                    <td align="center">
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td align="center" bgcolor="#E879F9" style="border-radius:12px;background-color:#E879F9;background-image: linear-gradient(90deg,#F472B6 0%,#C084FC 45%,#60A5FA 100%);">
                            <a href="${ctaUrl}" style="display:inline-block;padding:14px 26px;border-radius:12px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;line-height:1.2;">
            ...
            <tr>
              <td style="padding:18px 24px 22px 24px;">
                ...
                <img src="https://app.inrcy.com/signature-client.png" alt="iNrCy — Service client" width="512" style="width:100%;max-width:512px;height:auto;display:block;border:0;outline:none;" />
...
export function buildAnnualRenewalReminderEmail(input: AnnualRenewalReminderInput) {
  ...
  const body1 = daysBeforeRenewal <= 1
    ? `Votre abonnement annuel iNrCy sera renouvelé <strong>demain</strong> (${renewalDateFr}).`
    : `Votre abonnement annuel iNrCy sera renouvelé le <strong>${renewalDateFr}</strong> (J-${daysBeforeRenewal}).`;
  const body2 = `Le montant du renouvellement est de <strong>${amountLabel}</strong>. Si vous souhaitez continuer, vous n’avez rien à faire.`;
      ...
      <tr>
        <td align="center" style="padding:24px 12px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border-radius:14px;box-shadow:0 10px 30px rgba(15,23,42,.08);overflow:hidden;">
            <tr>
              <td style="padding:22px 24px 10px 24px;">
                <h1 style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:22px;font-weight:800;color:#0f172a;line-height:1.25;">iNrCy — ${title}</h1>
                <p style="margin:8px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#64748b;line-height:1.5;">Rappel automatique avant reconduction annuelle.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:0 24px 0 24px;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:18px 0 18px 0;"><tr><td align="center"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td align="center" bgcolor="#E879F9" style="border-radius:12px;background-color:#E879F9;background-image: linear-gradient(90deg,#F472B6 0%,#C084FC 45%,#60A5FA 100%);"><a href="${ctaUrl}" style="display:inline-block;padding:14px 26px;border-radius:12px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;line-height:1.2;">Gérer mon abonnement</a></td></tr></table></td></tr></table>
                <p style="margin:0;font-size:12px;color:#64748b;line-height:1.6;">Si le bouton ne fonctionne pas, copiez/collez ce lien dans votre navigateur :<br /><a href="${ctaUrl}" style="color:#0ea5e9;text-decoration:underline;word-break:break-all;">${ctaUrl}</a></p>
              </td>
            </tr>
            <tr>
              <td style="padding:18px 24px 22px 24px;">
                ...
                <div style="height:16px;line-height:16px;font-size:0;">&nbsp;</div>
                <img src="https://app.inrcy.com/signature-client.png" alt="iNrCy — Service client" width="512" style="width:100%;max-width:512px;height:auto;display:block;border:0;outline:none;" />
                <p style="margin:10px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#64748b;line-height:1.6;">Besoin d’aide ? Répondez simplement à cet email ou contactez-nous via <a href="https://inrcy.com" style="color:#0ea5e9;text-decoration:underline;">inrcy.com</a>.</p>
              </td>
            </tr>
          </table>
          <p style="margin:14px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#94a3b8;text-align:center;">© iNrCy — Cet email a été envoyé automatiquement.</p>
        </td>
      </tr>
    </table>
  </body>
