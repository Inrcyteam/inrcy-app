...
const es: DashboardCopy = {
  ...
  notifications: { ...en.notifications, aria: "Avisos", title: "Acciones", subtitle: "Tu cockpit avisa a tiempo.", settings: "Ajustes", markAllRead: "Leer todo", loading: "Cargando avisos…", empty: "Tu campana está vacía. Los próximos avisos aparecerán aquí.", delete: "Eliminar aviso", markRead: "Marcar leído" },
...
const it: DashboardCopy = {
  ...
  notifications: { ...es.notifications, aria: "Avvisi", title: "Azioni", subtitle: "Il cockpit avvisa al momento giusto.", settings: "Impostazioni", markAllRead: "Leggi tutto", loading: "Caricamento avvisi…", empty: "La campana è vuota. I prossimi avvisi saranno qui.", delete: "Elimina avviso", markRead: "Segna letto" },
...
const de: DashboardCopy = {
  ...
  notifications: { ...en.notifications, aria: "Infos", title: "Aktionen", subtitle: "Ihr Cockpit erinnert rechtzeitig.", settings: "Einstellungen", markAllRead: "Alles lesen", loading: "Infos werden geladen…", empty: "Die Glocke ist leer. Neue Business-Infos erscheinen hier.", delete: "Info löschen", markRead: "Als gelesen" },
...
const nl: DashboardCopy = {
  ...
  notifications: { ...en.notifications, aria: "Meldingen", title: "Acties", subtitle: "Uw cockpit herinnert op tijd.", settings: "Instellingen", markAllRead: "Alles lezen", loading: "Meldingen laden…", empty: "De bel is leeg. Nieuwe businessmeldingen komen hier.", delete: "Melding wissen", markRead: "Gelezen" },
...
const pt: DashboardCopy = {
  ...
  notifications: { ...es.notifications, aria: "Avisos", title: "Ações", subtitle: "O cockpit avisa no momento certo.", settings: "Definições", markAllRead: "Ler tudo", loading: "A carregar avisos…", empty: "A campainha está vazia. Novos avisos aparecerão aqui.", delete: "Apagar aviso", markRead: "Marcar lido" },
